          ...
          return (function (t) {
            ...
            function (t, e, n) {
              ...
              var s = {},
                ...
                f = {};
              function h(t, e) {
                if ((void 0 === e && (e = i.ANY), 'string' == typeof t)) n = f[t] || s[t];
                else if (t instanceof Text || t.nodeType === Node.TEXT_NODE) n = f.text;
                else if ('number' == typeof t)
                  t & i.LEVEL & i.BLOCK ? (n = f.block) : t & i.LEVEL & i.INLINE && (n = f.inline);
              ...
              (e.DATA_KEY = '__blot'),
                ((r = i = e.Scope || (e.Scope = {}))[(r.TYPE = 3)] = 'TYPE'),
                (r[(r.LEVEL = 12)] = 'LEVEL'),
                ...
                (e.create = function (t, e) {
                  ...
                  var r = t instanceof Node || t.nodeType === Node.TEXT_NODE ? t : n.create(e);
                  return new n(r, e);
                }),
                (e.find = function t(n, r) {
                  return (void 0 === r && (r = !1), null == n)
                    ? null
                    : null != n[e.DATA_KEY]
                      ? n[e.DATA_KEY].blot
                      : r
                    ...
                    'string' == typeof r.keyName
                      ...
                      : (null != r.className && (u[r.className] = r),
                        null != r.tagName &&
                          ...
                          (Array.isArray(r.tagName) ? r.tagName : [r.tagName]).forEach(
                            function (t) {
                              (null == c[t] || null == r.className) && (c[t] = r);
                            }
                          ))),
                    r
                  );
            ...
            function (t, e, n) {
              ...
              (a.prototype.insert = function (t, e) {
                ...
                (a.prototype.slice = function (t, e) {
                  ...
                  for (var n, r = [], o = l.iterator(this.ops), i = 0; i < e && o.hasNext(); )
                    i < t ? (n = o.next(t - i)) : ((n = o.next(e - i)), r.push(n)),
                      (i += l.length(n));
                  return new a(r);
                }),
                (a.prototype.compose = function (t) {
                  ...
                  if (null != i && 'number' == typeof i.retain && null == i.attributes) {
                    for (var s = i.retain; 'insert' === e.peekType() && e.peekLength() <= s; )
                      (s -= e.peekLength()), r.push(e.next());
                    i.retain - s > 0 && n.next(i.retain - s);
                  }
                  for (var u = new a(r); e.hasNext() || n.hasNext(); )
                ...
                (a.prototype.diff = function (t, e) {
                  ...
                  var n = [this, t].map(function (e) {
                      return e
                        .map(function (n) {
                          if (null != n.insert)
                            return 'string' == typeof n.insert ? n.insert : '\0';
                          throw Error(
                  ...
                  return (
                    s.forEach(function (t) {
                      for (var e = t[1].length; e > 0; ) {
                        ...
                        switch (t[0]) {
                          case r.INSERT:
                            (n = Math.min(c.peekLength(), e)), i.push(c.next(n));
                            break;
                          case r.DELETE:
                            (n = Math.min(e, u.peekLength())), u.next(n), i.delete(n);
                            break;
                          case r.EQUAL:
                            n = Math.min(u.peekLength(), c.peekLength(), e);
                            var a = u.next(n),
                              s = c.next(n);
                            o(a.insert, s.insert)
                ...
                (a.prototype.eachLine = function (t, e) {
                  e = e || '\n';
                  for (var n = l.iterator(this.ops), r = new a(), o = 0; n.hasNext(); ) {
                    if ('insert' !== n.peekType()) return;
                    var i = n.peek(),
                      s = l.length(i) - n.peekLength(),
                ...
                (a.prototype.transform = function (t, e) {
                  ...
                  for (
                    var n = l.iterator(this.ops), r = l.iterator(t.ops), o = new a();
                    n.hasNext() || r.hasNext();

                  )
                    if ('insert' === n.peekType() && (e || 'insert' !== r.peekType()))
                      o.retain(l.length(n.next()));
                    else if ('insert' === r.peekType()) o.push(r.next());
                    else {
                      ...
                      u.delete
                        ? o.push(u)
                        : o.retain(i, l.attributes.transform(s.attributes, u.attributes, e));
                    }
                  return o.chop();
                }),
              ...
              function x(t, e, n, o, i) {
                ...
                return (
                  'number' == typeof t.index && 'number' == typeof t.length
                    ? ('number' != typeof e && ((i = o), (o = n), (n = e)),
                      (e = t.length),
                      (t = t.index))
                    : 'number' != typeof e && ((i = o), (o = n), (n = e), (e = 0)),
                  (void 0 === n ? 'undefined' : r(n)) === 'object'
                    ? ((l = n), (i = o))
                    ...
                    [
                      {
                        ...
                        value: function (t, n, r, i) {
                          if (
                            0 > e.compare(this.statics.blotName, r) &&
                      ...
                      (t instanceof Date && e instanceof Date
                        ...
                        : t && e && ('object' == typeof t || 'object' == typeof e)
                          ? (function (t, e, n) {
                              ...
                              if (i(t)) return !!i(e) && l((t = r.call(t)), (e = r.call(e)), n);
                              if (a(t)) {
                                if (!a(e) || t.length !== e.length) return !1;
                  ...
                  o(
                    ...
                    [
                      ...
                      },
                      {
                        ...
                        value: function (t, n) {
                          if (t !== this.statics.blotName || !n) {
                            var o = r(this.descendant(c.default, this.length() - 1), 1)[0];
                      ...
                      },
                      {
                        ...
                        value: function (t, e, n) {
                          if (null == n) {
                            var o = r(this.descendant(c.default, t), 2),
                              i = o[0],
                              l = o[1];
                            i.insertAt(l, e);
                          }
                    ...
                    [
                      {
                        key: 'create',
                        value: function (t) {
                          var n = i(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(
                            this,
                            t
                          );
                    ...
                    i(t, [
                        ...
                        value: function (t) {
                          ...
                          return (
                            ...
                            (t = t.reduce(function (t, e) {
                              ...
                              return t.push(e);
                            }, new l.default())).reduce(function (t, l) {
                              ...
                              if (null != l.insert) {
                                if ('string' == typeof l.insert) {
                                  ...
                                  var d = o(e.scroll.line(t), 2),
                                    y = d[0],
                                    b = d[1],
                                    g = (0, v.default)({}, (0, f.bubbleFormats)(y));
                                  if (y instanceof h.default) {
                                    var m = o(y.descendant(s.default.Leaf, b), 1)[0];
                                    g = (0, v.default)(g, (0, f.bubbleFormats)(m));
                                  }
                                  c = a.default.attributes.diff(g, c) || {};
                                } else if ('object' === r(l.insert)) {
                                  var _ = Object.keys(l.insert)[0];
                                  if (null == _) return t;
                                  e.scroll.insertAt(t, _, l.insert[_]);
                                }
                                i += u;
                              }
                              return (
                                  ...
                                  return (
                                    null == t[r] ||
                                      (e[r] === t[r]
                                        ? (n[r] = e[r])
                                        : Array.isArray(e[r])
                                          ? 0 > e[r].indexOf(t[r]) && (n[r] = e[r].concat([t[r]]))
                                          : (n[r] = [e[r], t[r]])),
                                    n
                                  );
                                }, {});
                              })((0, f.bubbleFormats)(n), e);
                            }
                            return e;
                          });
                      ...
                      },
                      {
                        ...
                        value: function (t, e) {
                          ...
                          null != i &&
                            ((s =
                              i instanceof u.default ? i.newlineIndex(a) - a + 1 : i.length() - a),
                            (c = i
                              .delta()
                              .slice(a, a + s - 1)
                              .insert('\n')));
                          var f = this.getContents(t, e + s).diff(
                              new l.default().insert(n).concat(c)
                            ),
                            h = new l.default().retain(t).concat(f);
                    ...
                    o(t, [
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          ...
                          e = Math.min((t = Math.min(t, n - 1)) + e, n - 1) - t;
                          var o = void 0,
                            i = r(this.scroll.leaf(t), 2),
                            l = i[0],
                            a = i[1];
                          if (null == l) return null;
                          var s = r(l.position(a, !0), 2);
                          (o = s[0]), (a = s[1]);
                          var u = document.createRange();
                          if (e > 0) {
                            u.setStart(o, a);
                            var c = r(this.scroll.leaf(t + e), 2);
                            if (((l = c[0]), (a = c[1]), null == l)) return null;
                            var f = r(l.position(a, !0), 2);
                            return (
                              (o = f[0]), (a = f[1]), u.setEnd(o, a), u.getBoundingClientRect()
                            );
                          }
                          var h = 'left',
                            p = void 0;
                          return (
                            o instanceof Text
                              ? (a < o.data.length
                                  ? (u.setStart(o, a), u.setEnd(o, a + 1))
                                  : (u.setStart(o, a - 1), u.setEnd(o, a), (h = 'right')),
                                (p = u.getBoundingClientRect()))
                              : ((p = l.domNode.getBoundingClientRect()), a > 0 && (h = 'right')),
                            {
                        ...
                        value: function (t) {
                          ...
                          return (
                            n.forEach(function (t, n) {
                              t = Math.min(i - 1, t);
                              var l = void 0,
                                a = r(e.scroll.leaf(t), 2),
                                s = a[0],
                                u = a[1],
                                c = r(s.position(u, 0 !== n), 2);
                              (l = c[0]), (u = c[1]), o.push(l, u);
                            }),
                          ...
                          if (null != e) {
                            ...
                            if (null != n) {
                              var o = this.scroll.length() - 1,
                                i = r(this.scroll.line(Math.min(e.index, o)), 1)[0],
                                l = i;
                              if (
                                (e.length > 0 &&
                                  (l = r(this.scroll.line(Math.min(e.index + e.length, o)), 1)[0]),
                                null != i && null != l)
                              ) {
                                var a = t.getBoundingClientRect();
                                n.top < a.top
                                  ? (t.scrollTop -= a.top - n.top)
                                  : n.bottom > a.bottom && (t.scrollTop += n.bottom - a.bottom);
                              }
                            }
                          }
                        },
                        ...
                        value: function () {
                          ...
                          if (
                            ...
                            (u = this.emitter).emit.apply(
                              ...
                              t !== s.default.sources.SILENT && (c = this.emitter).emit.apply(c, f);
                          }
                        },
                      },
                    ]),
            ...
            function (t, e) {
              var n = (function () {
                ...
                function i(l, s, u, c, f) {
                  ...
                  return (
                    ...
                    (function l(u, y) {
                      ...
                      if (0 === y || 'object' != typeof u) return u;
                      if (r(u, t)) v = new t();
                      else if (r(u, e)) v = new e();
                      else if (r(u, n))
                        ...
                        if (d && o.isBuffer(u))
                          return (
                            (v = o.allocUnsafe ? o.allocUnsafe(u.length) : new o(u.length)),
                            u.copy(v),
                            v
                          );
                        r(u, Error)
                          ? (v = Object.create(u))
                          : void 0 === c
                            ? (v = Object.create((b = Object.getPrototypeOf(u))))
                      ...
                      u))
                        b && (g = Object.getOwnPropertyDescriptor(b, _)),
                          (g && null == g.set) || (v[_] = l(u[_], y - 1));
                      if (Object.getOwnPropertySymbols)
                        for (var O = Object.getOwnPropertySymbols(u), _ = 0; _ < O.length; _++) {
                          var x = O[_],
                            k = Object.getOwnPropertyDescriptor(u, x);
                          (!k || k.enumerable || f) &&
                            ((v[x] = l(u[x], y - 1)),
                            k.enumerable || Object.defineProperty(v, x, { enumerable: !1 }));
                        }
                      if (f)
                        for (var E = Object.getOwnPropertyNames(u), _ = 0; _ < E.length; _++) {
                          var w = E[_],
                ...
                function a(t) {
                  var e = '';
                  return (
                    t.global && (e += 'g'), t.ignoreCase && (e += 'i'), t.multiline && (e += 'm'), e
                  );
                }
                return (
                ...
                return (
                  ...
                  o(e, [
                    ...
                    },
                    {
                      key: 'deleteAt',
                      value: function (t, n) {
                        var o = r(this.line(t), 2),
                          l = o[0],
                          a = o[1],
                          u = r(this.line(t + n), 1)[0];
                        if (
                          (i(
                            e.prototype.__proto__ || Object.getPrototypeOf(e.prototype),
                            'deleteAt',
                          ...
                          if (l instanceof s.BlockEmbed || u instanceof s.BlockEmbed) {
                            this.optimize();
                            return;
                          }
                          if (l instanceof f.default) {
                            var h = l.newlineIndex(l.length(), !0);
                            if (h > -1 && (l = l.split(h + 1)) === u) {
                              this.optimize();
                              return;
                            }
                          } else if (u instanceof f.default) {
                            var p = u.newlineIndex(0);
                            p > -1 && u.split(p + 1);
                          }
                          var d = u.children.head instanceof c.default ? null : u.children.head;
                          l.moveChildren(u, d), l.remove();
                        }
                        this.optimize();
                      },
                    },
                        ...
                        return (function t(e, n, r) {
                          ...
                          return (
                            e.children.forEachAt(n, r, function (e, n, r) {
                              d(e)
                                ? o.push(e)
                                : e instanceof l.default.Container && (o = o.concat(t(e, n, i))),
                                (i -= r);
                            }),
                            o
                          );
                      ...
                      value: function (t) {
                        if (!0 !== this.batch) {
                          ...
                          'string' == typeof t && (n = t),
                            ...
                            t.length > 0 &&
                              this.emitter.emit(a.default.events.SCROLL_BEFORE_UPDATE, n, t),
                            i(
                              e.prototype.__proto__ || Object.getPrototypeOf(e.prototype),
                              'update',
                              this
            ...
            function (t, e, n) {
                    ...
                    return (
                      ...
                      /Firefox/i.test(navigator.userAgent)
                        ? (r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0 }, O),
                          r.addBinding({ key: e.keys.DELETE }, { collapsed: !0 }, x))
                        : (r.addBinding(
                      ...
                      r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !1 }, k),
                      r.addBinding({ key: e.keys.DELETE }, { collapsed: !1 }, k),
                      r.addBinding(
                        {
                          key: e.keys.BACKSPACE,
                          altKey: null,
                            ...
                            if (!n.defaultPrevented) {
                              ...
                              if (0 !== l.length) {
                                ...
                                if (null != s && t.quill.hasFocus()) {
                                  var u = o(t.quill.getLine(s.index), 2),
                                    c = u[0],
                                    h = u[1],
                                    p = o(t.quill.getLeaf(s.index), 2),
                                    d = p[0],
                                    y = p[1],
                                    v = o(
                                      0 === s.length ? [d, y] : t.quill.getLeaf(s.index + s.length),
                                      2
                                    ),
                                    b = v[0],
                                    g = v[1],
                                    m = d instanceof f.default.Text ? d.value().slice(0, y) : '',
                                    _ = b instanceof f.default.Text ? b.value().slice(g) : '',
                                    O = {
                                      collapsed: 0 === s.length,
                                      empty: 0 === s.length && 1 >= c.length(),
                                  ...
                                  l.some(function (e) {
                                    if (
                                      (null != e.collapsed && e.collapsed !== O.collapsed) ||
                                      (null != e.empty && e.empty !== O.empty) ||
                                      (null != e.offset && e.offset !== O.offset)
                                    )
                                      return !1;
                                    if (Array.isArray(e.format)) {
                                      ...
                                      !Object.keys(e.format).every(function (t) {
                                        return !0 === e.format[t]
                                          ...
                                          : !1 === e.format[t]
                                            ? null == O.format[t]
                                            : (0, a.default)(e.format[t], O.format[t]);
                                      })
                                    )
                                      return !1;
                                    return (
                                      !!(
                                        (null == e.prefix || e.prefix.test(O.prefix)) &&
                                        (null == e.suffix || e.suffix.test(O.suffix))
                                      ) && !0 !== e.handler.call(t, s, O)
                                    );
                                  }) && n.preventDefault();
                                }
                              }
                ...
                return (
                  ...
                  v(n, 'handler', function (n) {
                    ...
                    return (
                      ...
                      !(o(this.quill.getLeaf(r), 1)[0] instanceof f.default.Embed) ||
                        (t === m.keys.LEFT
                          ? e
              ...
              function O(t, e) {
                if (!(0 === t.index || 1 >= this.quill.getLength())) {
                  var n = o(this.quill.getLine(t.index), 1)[0],
                    r = {};
                  if (0 === e.offset) {
                    var i = o(this.quill.getLine(t.index - 1), 1)[0];
                    if (null != i && i.length() > 1) {
                      var l = n.formats(),
                        a = this.quill.getFormat(t.index - 1, 1);
                      r = c.default.attributes.diff(l, a) || {};
                    }
                  }
                  var s = /[\uD800-\uDBFF][\uDC00-\uDFFF]$/.test(e.prefix) ? 2 : 1;
                  this.quill.deleteText(t.index - s, s, h.default.sources.USER),
                    Object.keys(r).length > 0 &&
                      this.quill.formatLine(t.index - s, s, r, h.default.sources.USER),
                    this.quill.focus();
                }
              }
              function x(t, e) {
                ...
                if (!(t.index >= this.quill.getLength() - n)) {
                  var r = {},
                    i = 0,
                    l = o(this.quill.getLine(t.index), 1)[0];
                  if (e.offset >= l.length() - 1) {
                    var a = o(this.quill.getLine(t.index + 1), 1)[0];
                    if (a) {
                      var s = l.formats(),
                        u = this.quill.getFormat(t.index, 1);
                      (r = c.default.attributes.diff(s, u) || {}), (i = a.length());
                    }
                  }
                ...
                return {
                  ...
                  handler: function (e) {
                    var n = f.default.query('code-block'),
                      r = e.index,
                      i = e.length,
                      l = o(this.quill.scroll.descendant(n, r), 2),
                      a = l[0],
                      s = l[1];
                    if (null != a) {
                      var u = this.quill.getIndex(a),
                        c = a.newlineIndex(s, !0) + 1,
                        p = a.newlineIndex(u + s + i),
                        d = a.domNode.textContent.slice(c, p).split('\n');
                      (s = 0),
              ...
              function A(t) {
                if ('string' == typeof t || 'number' == typeof t) return A({ key: t });
                if (
                  ((void 0 === t ? 'undefined' : r(t)) === 'object' && (t = (0, l.default)(t, !1)),
                  'string' == typeof t.key)
                ) {
                ...
                (m.DEFAULTS = {
                  bindings: {
                    ...
                    'checklist enter': {
                      ...
                      format: { list: 'checked' },
                      handler: function (t) {
                        var e = o(this.quill.getLine(t.index), 2),
                          n = e[0],
                          r = e[1],
                          i = (0, s.default)({}, n.formats(), { list: 'checked' }),
                          l = new u.default()
                            .retain(t.index)
                            .insert('\n', i)
                            .retain(n.length() - r - 1)
                    ...
                    'header enter': {
                      ...
                      suffix: /^$/,
                      handler: function (t, e) {
                        var n = o(this.quill.getLine(t.index), 2),
                          r = n[0],
                          i = n[1],
                          l = new u.default()
                            .retain(t.index)
                    ...
                    'list autofill': {
                      ...
                      handler: function (t, e) {
                        var n = e.prefix.length,
                          r = o(this.quill.getLine(t.index), 2),
                          i = r[0],
                          l = r[1];
                        if (l > n) return !0;
                        var a = void 0;
                      ...
                      handler: function (t) {
                        var e = o(this.quill.getLine(t.index), 2),
                          ...
                          i = new u.default()
                            ...
                            .delete(1);
                        this.quill.updateContents(i, h.default.sources.USER);
                      },
                    },
                      ...
                      value: function (t) {
                        ...
                        if (
                          ...
                          if ('function' == typeof Event)
                            ...
                            ('undefined' == typeof Event ? 'undefined' : r(Event)) === 'object'
                          ) {
                ...
                o = (function () {
                  ...
                  return (
                    ...
                    (t.create = function (t) {
                      ...
                      return (
                        Array.isArray(this.tagName)
                          ? ('string' == typeof t &&
                              parseInt((t = t.toUpperCase())).toString() === t &&
                              (t = parseInt(t)),
                            (e =
                              'number' == typeof t
                    ...
                    (t.prototype.offset = function (t) {
                      return (void 0 === t && (t = this.parent), null == this.parent || this == t)
                        ? 0
            ...
            function (t, e, n) {
                        ...
                        value: function (t, e) {
                          t.forEach(function (t) {
                            (t.getAttribute('class') || '').split(/\s+/).forEach(function (n) {
                              if (n.startsWith('ql-') && null != e[(n = n.slice(3))]) {
                        ...
                        value: function (t, e) {
                          ...
                          (this.pickers = t.map(function (t) {
                            if (t.classList.contains('ql-align'))
                              return (
                                null == t.querySelector('option') && w(t, g),
                                ...
                                null == t.querySelector('option') &&
                                  (t.classList.contains('ql-font')
                                    ...
                                    : t.classList.contains('ql-header')
                                      ? w(t, O)
                                      : t.classList.contains('ql-size') && w(t, x)),
                                new h.default(t)
                              );
                            var n = t.classList.contains('ql-background') ? 'background' : 'color';
                            return (
                              null == t.querySelector('option') &&
                                w(t, m, 'background' === n ? '#ffffff' : '#000000'),
                              new c.default(t, e[n])
                            );
                          })),
              ...
              k.DEFAULTS = (0, i.default)(!0, {}, u.default.DEFAULTS, {
                modules: {
                  toolbar: {
                    handlers: {
                      formula: function () {
            ...
            function (t, e) {
                  ...
                  f = (function (t, e) {
                    ...
                    var c = (function (t, e) {
                      var n,
                        ...
                        a,
                        s,
                        u = t.length > e.length ? t : e,
                        c = t.length > e.length ? e : t;
                      if (u.length < 4 || 2 * c.length < u.length) return null;
                      function f(t, e, n) {
                        for (
                          var r,
                            l,
                      ...
                      var h = f(u, c, Math.ceil(u.length / 4)),
                        p = f(u, c, Math.ceil(u.length / 2));
                      return h || p
                        ? ((n = p ? (h && h[4].length > p[4].length ? h : p) : h),
                          t.length > e.length
                            ? ((r = n[0]), (l = n[1]), (a = n[2]), (s = n[3]))
                            : ((a = n[0]), (s = n[1]), (r = n[2]), (l = n[3])),
                          [r, l, a, s, n[4]])
                        : null;
                    })(t, e);
                    if (c) {
                    ...
                    return (function (t, e) {
                      ...
                      (a[i + 1] = 0), (s[i + 1] = 0);
                      for (
                        var c = n - o, f = c % 2 != 0, h = 0, p = 0, d = 0, y = 0, v = 0;
                        v < i;
                        v++
                      ) {
                        for (var b = -v + h; b <= v - p; b += 2) {
                          ...
                          if (((a[m] = g), g > n)) p += 2;
                            ...
                            if (O >= 0 && O < l && -1 != s[O]) {
                              var x = n - s[O];
                              if (g >= x) return r(t, e, g, _);
                            }
                          }
                        }
                        for (var k = -v + d; k <= v - y; k += 2) {
                          for (
                            var x,
                              O = i + k,
                              E =
                                (x =
                                  k == -v || (k != v && s[O - 1] < s[O + 1])
                                    ? s[O + 1]
                                    : s[O - 1] + 1) - k;
                            x < n && E < o && t.charAt(n - x - 1) == e.charAt(o - E - 1);
                ...
                return (
                  ...
                  (function t(e) {
                    ...
                    for (r = 1; r < e.length - 1; )
                      0 == e[r - 1][0] &&
                        0 == e[r + 1][0] &&
                        (e[r][1].substring(e[r][1].length - e[r - 1][1].length) == e[r - 1][1]
                          ? ((e[r][1] =
                              e[r - 1][1] +
                  ...
                  null != a &&
                    (f = (function (t, e) {
                      var n = (function (t, e) {
                        ...
                        i = r[o],
                        a = r[o + 1];
                      if (null == i || 0 !== i[0]) return t;
                      if (null != a && i[1] + a[1] === a[1] + i[1])
                        return r.splice(o, 2, a, i), l(r, o, 2);
                      if (null == a || 0 !== a[1].indexOf(i[1])) return t;
                      r.splice(o, 2, [a[0], i[1]], [0, i[1]]);
                      var s = a[1].slice(i[1].length);
                      return s.length > 0 && r.splice(o + 2, 0, [a[0], s]), l(r, o, 3);
                    })(f, a)),
                  (f = (function (t) {
                    for (
                      var e,
                        n = !1,
                        r = function (t) {
                          return t.charCodeAt(0) >= 56320 && 57343 >= t.charCodeAt(0);
                        },
                        o = 2;
                      o < t.length;
                      o += 1
                      ...
                      0 === t[o - 2][0] &&
                        (e = t[o - 2][1]).charCodeAt(e.length - 1) >= 55296 &&
              ...
              (n.INSERT = 1), (n.DELETE = -1), (n.EQUAL = 0), (t.exports = n);
            },
            function (t, e) {
            ...
            function (t, e) {
              ...
              Object.create && ((o.prototype = Object.create(null)), new o().__proto__ || (r = !1)),
                ...
                (l.prototype.listeners = function (t, e) {
                  ...
                  if (!o) return [];
                  if (o.fn) return [o.fn];
                  for (var i = 0, l = o.length, a = Array(l); i < l; i++) a[i] = o[i].fn;
                  return a;
                }),
                (l.prototype.emit = function (t, e, n, o, i, l) {
                  ...
                  if (c.fn) {
                    ...
                    for (u = 1, s = Array(f - 1); u < f; u++) s[u - 1] = arguments[u];
                    ...
                    for (u = 0; u < p; u++)
                      switch ((c[u].once && this.removeListener(t, c[u].fn, void 0, !0), f)) {
                        ...
                        case 4:
                          ...
                          break;
                        default:
                          if (!s) for (h = 1, s = Array(f - 1); h < f; h++) s[h - 1] = arguments[h];
                ...
                (l.prototype.removeListener = function (t, e, n, i) {
                  ...
                  if (a.fn)
                    ...
                    for (var s = 0, u = [], c = a.length; s < c; s++)
                      (a[s].fn !== e || (i && !a[s].once) || (n && a[s].context !== n)) &&
                        u.push(a[s]);
                    u.length
            ...
            function (t, e, n) {
                  ...
                  [
                    ...
                    function (t, e) {
                      ...
                      return r <= 0
                        ? e
                        : e.compose(
                            new a.default().retain(e.length() - 1).retain(1, { indent: r })
                          );
                    },
                  ],
                  ['b', P.bind(P, 'bold')],
                ...
                N = (function (t) {
                  function e(t, n) {
                    ...
                    return (
                      ...
                      (r.matchers = []),
                      k.concat(r.options.matchers).forEach(function (t) {
                        var e = o(t, 2),
                          i = e[0],
                          l = e[1];
                    ...
                    i(e, [
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          ...
                          var r = o(this.prepareMatching(), 2),
                            i = r[0],
                            l = r[1],
                            s = (function t(e, n, r) {
                          ...
                          return (
                            q(s, '\n') &&
                              ...
                              (s = s.compose(new a.default().retain(s.length() - 1).delete(1))),
                            O.log('convert', this.container.innerHTML, s),
                            (this.container.innerHTML = ''),
                            s
                          );
                        },
              ...
              function A(t, e, n) {
                return (void 0 === e ? 'undefined' : r(e)) === 'object'
              ...
              function T(t) {
                return (
                  0 !== t.childNodes.length && ['block', 'list-item'].indexOf(j(t).display) > -1
                );
              }
              function P(t, e, n) {
                return A(n, t, !0);
                  ...
                  n
                    ...
                    .forEach(function (e) {
                      ...
                      (null != n && ((i[n.attrName] = n.value(t)), i[n.attrName])) ||
                        ...
                        null != (n = w[e]) &&
                          (n.attrName === e || n.keyName === e) &&
                          (i[(n = w[e]).attrName] = n.value(t) || void 0));
                    }),
              ...
              function M(t, e) {
                if (T(t) && null != t.nextElementSibling && !q(e, '\n\n')) {
                  var n =
                    t.offsetHeight + parseFloat(j(t).marginTop) + parseFloat(j(t).marginBottom);
                      ...
                      [
                        {
                          key: 'create',
                          value: function () {
                            return i(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(
                              this
                            );
                          },
                        },
                    ...
                    return i.container instanceof HTMLElement
                      ? (i.container.classList.add('ql-toolbar'),
                        ...
                        i.quill.on(a.default.events.SCROLL_OPTIMIZE, function () {
                          var t = r(i.quill.selection.getRange(), 1)[0];
                          i.update(t);
                        }),
                        i)
                          ...
                          if (n) {
                            if (
                              ...
                              if (
                                ...
                                h.warn('ignoring attaching to disabled format', n, t);
                                return;
                              }
                              if (null == l.default.query(n)) {
                                h.warn('ignoring attaching to nonexistent format', n, t);
                                return;
                              }
                            }
                            ...
                            t.addEventListener(o, function (o) {
                              ...
                              if ('SELECT' === t.tagName) {
                                ...
                                var h = t.options[t.selectedIndex];
                                f = !h.hasAttribute('selected') && (h.value || !1);
                              } else
                                (f =
                                  ...
                                  o.preventDefault();
                              e.quill.focus();
                              var p = r(e.quill.selection.getRange(), 1)[0];
                              if (null != e.handlers[n]) e.handlers[n].call(e, f);
                              else if (l.default.query(n).prototype instanceof l.default.Embed) {
                                if (!(f = prompt('Enter ' + n))) return;
                              ...
                              } else e.quill.format(n, f, a.default.sources.USER);
                              e.update(p);
                            }),
                      ...
                      e.forEach(function (t) {
                        if ('string' == typeof t) d(n, t);
                          ...
                          var e,
                            ...
                            o = t[r];
                          Array.isArray(o)
                            ? ((e = document.createElement('select')).classList.add('ql-' + r),
                              o.forEach(function (t) {
                ...
                (p.DEFAULTS = {
                  ...
                  handlers: {
                    clean: function () {
                      ...
                      null != e &&
                        (0 == e.length
                          ? Object.keys(this.quill.getFormat()).forEach(function (e) {
                          ...
                          this.quill.on(a.default.events.SELECTION_CHANGE, function (e, n, o) {
                            if (null != e) {
                              if (0 === e.length && o === a.default.sources.USER) {
                                var i = r(t.quill.scroll.descendant(c.default, e.index), 2),
                                  l = i[0],
                                  s = i[1];
                                if (null != l) {
                                  t.linkRange = new f.Range(e.index - s, l.length());
                                  var u = c.default.formats(l.domNode);
                    ...
                    [
                      {
                        ...
                        value: function (t) {
                          return t.tagName === this.tagName
                            ? void 0
                            : o(e.__proto__ || Object.getPrototypeOf(e), 'formats', this).call(
                                this,
                                t
                              );
                        },
                  ...
                  r(e, null, [
                    {
                      key: 'create',
                      value: function (t) {
                        var n = o(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(
                          this,
                          'ordered' === t ? 'OL' : 'UL'
                        );
                        return (
                        ...
                        value: function (t) {
                          return 'super' === t
                            ...
                            : 'sub' === t
                              ...
                              : i(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(
                                  this,
                                  t
                                );
                        },
