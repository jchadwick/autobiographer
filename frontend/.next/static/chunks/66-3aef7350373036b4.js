  ...
  [66],
  {
              ...
              (t.Buffer = a),
                ...
                (a.concat = function (e, t) {
                  ...
                  for (r = 0; r < e.length; ++r) {
                    var i = e[r];
                    if ((x(i, Uint8Array) && (i = a.from(i)), !a.isBuffer(i)))
                      throw TypeError('"list" argument must be an Array of Buffers');
                ...
                (a.prototype.write = function (e, t, r, n) {
                  ...
                  for (var m = !1; ; )
                    switch (n) {
                      ...
                      case 'utf8':
                      case 'utf-8':
                        return (u = t), (f = r), U(S(e, this.length - u), this, u, f);
                      case 'ascii':
                        return (l = t), (c = r), U(T(e), this, l, c);
                      case 'latin1':
                      case 'binary':
                        return (o = this), (i = e), (s = t), (a = r), U(T(i), o, s, a);
                      case 'base64':
                ...
                (a.prototype.writeUInt8 = function (e, t, r) {
                  return (
                    (e = +e), (t >>>= 0), r || E(this, e, t, 1, 255, 0), (this[t] = 255 & e), t + 1
                  );
                }),
    ...
    7066: function (e, t, r) {
      ...
      let { toString: g } = Object.prototype,
        ...
        { iterator: b, toStringTag: w } = Symbol,
        E =
        ...
        P = v('FileList'),
        _ = v('URLSearchParams'),
        [k, F, I, D] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(v);
          ...
          'undefined' != typeof globalThis
            ...
            : 'undefined' != typeof self
              ...
              : 'undefined' != typeof window
                ...
                : global,
        J = e => !O(e) && e !== z,
        W = ((o = 'undefined' != typeof Uint8Array && m(Uint8Array)), e => o && e instanceof o),
        H = v('HTMLFormElement'),
        V = (
          ({ hasOwnProperty: e }) =>
          (t, r) =>
            ...
            : f
              ? ((l = `axios@${Math.random()}`),
                ...
                z.addEventListener(
                  'message',
                  ({ source: e, data: t }) => {
                    e === z && t === l && c.length && c.shift()();
                  },
                  !1
                ),
                e => {
                  c.push(e), z.postMessage(l, '*');
                })
              : e => setTimeout(e)),
        G =
          'undefined' != typeof queueMicrotask
            ? queueMicrotask.bind(z)
            : (void 0 !== y && y.nextTick) || Y;
      var Z = {
        isArray: R,
        isArrayBuffer: S,
        isBuffer: function (e) {
        ...
        isSpecCompliantForm: function (e) {
          return !!(e && B(e.append) && 'FormData' === e[w] && e[b]);
        },
        toJSONObject: e => {
          let t = Array(10),
            r = (e, n) => {
      ...
      var ea = function (e, t, r) {
        ...
        function f(e, r, o) {
          ...
          if (e && !o && 'object' == typeof e) {
            if (Z.endsWith(r, '{}')) (r = n ? r : r.slice(0, -2)), (e = JSON.stringify(e));
              ...
              var f;
              if (
                (Z.isArray(e) && ((f = e), Z.isArray(f) && !f.some(en))) ||
                ...
                return (
                  ...
                  a.forEach(function (e, n) {
                    Z.isUndefined(e) ||
                      null === e ||
                      t.append(!0 === s ? ei([r], n, i) : null === s ? r : r + '[]', u(e));
                  }),
                  !1
                );
            }
        ...
        let l = [],
          c = Object.assign(es, { defaultVisitor: f, convertValue: u, isVisitable: en });
                ...
                Z.forEach(r, function (r, i) {
                  !0 ===
                    (!(Z.isUndefined(r) || null === r) &&
                      o.call(t, r, Z.isString(i) ? i.trim() : i, n, c)) &&
                    e(r, n ? n.concat(i) : [i]);
                }),
                l.pop();
            }
      ...
      var ed = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
      ...
      let eb = 'undefined' != typeof window && 'undefined' != typeof document,
        ...
        eA = (eb && window.location.href) || 'http://localhost';
      var eR = {
          ...p,
          isBrowser: !0,
          ...
          function (e, t) {
            ...
            if (i) {
              ...
              if ((r = Z.isFileList(e)) || n.indexOf('multipart/form-data') > -1) {
                ...
                return ea(r ? { 'files[]': e } : e, t && new t(), this.formSerializer);
              }
            }
            return i || o
      ...
      class eN {
        ...
        set(e, t, r) {
          ...
          if (Z.isPlainObject(e) || e instanceof this.constructor) i(e, t);
          else if (Z.isString(e) && (e = e.trim()) && !eL(e)) i(eB(e), t);
            ...
            for (let t of e) {
              ...
              r[(o = t[0])] = (n = r[o]) ? (Z.isArray(n) ? [...n, t[1]] : [n, t[1]]) : t[1];
            }
            i(r, t);
          } else null != e && o(t, e, r);
          return this;
        ...
        static accessor(e) {
          let t = (this[eU] = this[eU] = { accessors: {} }).accessors,
            r = this.prototype;
          function n(e) {
            let n = ex(e);
            t[n] ||
      ...
      eN.accessor([
        ...
        Z.reduceDescriptors(eN.prototype, ({ value: e }, t) => {
      ...
      let eM = (e, t, r = 3) => {
        ...
        ez =
          ...
          (...t) =>
            Z.asap(() => e(...t));
      var eJ = eR.hasStandardBrowserEnv
          ? ((i = new URL(eR.origin)),
            (s = eR.navigator && /(msie|trident)/i.test(eR.navigator.userAgent)),
            e => (
              (e = new URL(e, eR.origin)),
              i.protocol === e.protocol && i.host === e.host && (s || i.port === e.port)
            ))
          : () => !0,
        eW = eR.hasStandardBrowserEnv
          ? {
              write(e, t, r, n, o, i) {
      ...
      function eK(e, t) {
        ...
        let u = {
          ...
          responseEncoding: s,
          validateStatus: a,
          headers: (e, t, r) => o(eV(e), eV(t), r, !0),
        };
        return (
          Z.forEach(Object.keys(Object.assign({}, e, t)), function (n) {
            let i = u[n] || o,
              s = i(e[n], t[n], n);
      ...
      var e$ = e => {
          ...
          if (
            ...
            (o && Z.isFunction(o) && (o = o(r)), o || (!1 !== o && eJ(r.url)))
          ) {
            let e = i && s && eW.read(s);
            e && a.set(i, e);
          }
            ...
            return new Promise(function (t, r) {
              ...
              y.open(u.method.toUpperCase(), u.url, !0),
                ...
                (u.cancelToken || u.signal) &&
                  ((n = t => {
                    y && (r(!t || t.type ? new ek(null, e, y) : t), y.abort(), (y = null));
                  }),
            ...
            let r,
              ...
              o = function (e) {
                if (!r) {
                  ...
                  n.abort(t instanceof Q ? t : new ek(t instanceof Error ? t.message : t));
                }
              },
              i =
                t &&
      ...
      let eG = function* (e, t) {
        ...
        eZ = async function* (e, t) {
          for await (let r of eQ(e)) yield* eG(r, t);
        },
        eQ = async function* (e) {
        ...
        e4 = e2 && e5(() => Z.isReadableStream(new Response('').body)),
        e3 = { stream: e4 && (e => e.body) };
      e1 &&
        ((h = new Response()),
        ['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach(e => {
          e3[e] ||
            (e3[e] = Z.isFunction(h[e])
              ? t => t[e]()
              : (t, r) => {
      ...
      let e7 = async e => {
          ...
          if (Z.isSpecCompliantForm(e)) {
            let t = new Request(eR.origin, { method: 'POST', body: e });
        ...
        te = {
          ...
          fetch:
            ...
            (async e => {
              ...
              let y = eY([s, a && a.toAbortSignal()], u),
                g =
                  y &&
                  y.unsubscribe &&
                  (() => {
              ...
              try {
                if (l && e8 && 'get' !== o && 'head' !== o && 0 !== (r = await e9(h, i))) {
                  let e,
                    t = new Request(n, { method: 'POST', body: i, duplex: 'half' });
                  if (
                    (Z.isFormData(i) && (e = t.headers.get('content-type')) && h.setContentType(e),
                    t.body)
                  ) {
                    let [e, n] = eq(r, eM(ez(l)));
                    i = e0(t.body, 65536, e, n);
                  }
                }
                ...
                c = c || 'text';
                let m = await e3[Z.findKey(e3, c) || 'text'](a, e);
                return (
                  !u && g && g(),
                ...
                if ((g && g(), r && 'TypeError' === r.name && /Load failed|fetch/i.test(r.message)))
      ...
      let tt = e => `- ${e}`,
        tr = e => Z.isFunction(e) || null === e || !1 === e;
      var tn = e => {
        let t, r;
        let { length: n } = (e = Z.isArray(e) ? e : [e]),
          o = {};
        for (let i = 0; i < n; i++) {
          let n;
          if (((r = t = e[i]), !tr(t) && void 0 === (r = te[(n = String(t)).toLowerCase()])))
      ...
      function ti(e) {
        return (
          ...
          tn(e.adapter || eS.adapter)(e).then(
            function (t) {
              return (
                to(e),
      ...
      class tc {
        ...
        _request(e, t) {
          ...
          let { transitional: o, paramsSerializer: i, headers: s } = (t = eK(this.defaults, t));
          void 0 !== o &&
            tf.assertOptions(
              o,
              {
            ...
            null != i &&
              (Z.isFunction(i)
                ...
                : tf.assertOptions(i, { encode: tl.function, serialize: tl.function }, !0)),
            ...
            tf.assertOptions(
              t,
              { baseUrl: tl.spelling('baseURL'), withXsrfToken: tl.spelling('withXSRFToken') },
              !0
            ),
        ...
        getUri(e) {
          return eh(
            eH((e = eK(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls),
            e.params,
            e.paramsSerializer
          );
        }
      ...
      Z.forEach(['delete', 'get', 'head', 'options'], function (e) {
        tc.prototype[e] = function (t, r) {
          return this.request(eK(r || {}, { method: e, url: t, data: (r || {}).data }));
        };
      }),
      ...
      let td = (function e(t) {
        ...
        return (
          Z.extend(n, tc.prototype, r, { allOwnKeys: !0 }),
      ...
      (td.Axios = tc),
        ...
        (td.mergeConfig = eK),
        (td.AxiosHeaders = eN),
        (td.formToJSON = e => eO(Z.isHTMLForm(e) ? new FormData(e) : e)),
        (td.getAdapter = tn),
