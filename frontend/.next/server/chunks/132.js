    ...
    1401: (e, t, r) => {
      ...
      function f(e, t, r) {
        ...
        if ((_.split('?', 1)[0] || '').match(/(\/\/|\\)/)) {
          ...
          let t = (0, u.normalizeRepeatedSlashes)(_);
          d = (p ? p[0] : '') + t;
        }
        ...
        try {
          ...
          if ((0, s.isDynamicRoute)(e.pathname) && e.searchParams && r) {
            let r = (0, n.searchParamsToUrlQuery)(e.searchParams),
              { result: u, params: i } = (0, c.interpolateAs)(e.pathname, e.pathname, r);
            u &&
          ...
          return (
            Object.keys(r).forEach(e => {
              let t = r[e],
                n = a[t.pos];
              void 0 !== n &&
                (u[e] = ~n.indexOf('/') ? n.split('/').map(e => o(e)) : t.repeat ? [o(n)] : o(n));
            }),
            u
          );
        };
          ...
          parameterizedRoute: t
            .map(e => {
              let t = a.INTERCEPTION_ROUTE_MARKERS.find(t => e.startsWith(t)),
                u = e.match(/\[((?:\[.*\])|.+)\]/);
              if (t && u) {
                let { key: e, optional: a, repeat: l } = i(u[1]);
                return (
              ...
              {
                let { key: e, repeat: t, optional: a } = i(u[1]);
                return (
