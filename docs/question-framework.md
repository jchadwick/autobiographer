# Autobiographer: Question Framework

**Date:** May 1, 2025  
**Version:** 1.0

This document defines the question framework that will guide users through creating their autobiography. Questions are organized by life stages and thematic categories.

## 1. Question Organization

Questions in the Autobiographer application are organized in two dimensions:

1. **Life Stages**: Chronological periods of life
2. **Thematic Categories**: Aspects of life that span across time periods

This dual organization allows users to approach their autobiography either chronologically or thematically, depending on their preference.
...
3. **Early Temperament**
   - "How would your parents describe you as a young child?"
   - "What activities made you happiest as a small child?"
   - "Were there things that frightened you when you were very young?"
...
3. **Lifelong Learning**
   - "What skills have you taught yourself outside of formal education?"
   - "What books or other media have significantly influenced your thinking?"
   - "What would you have liked to study if given another opportunity?"
...
3. **Work-Life Balance**
   ...
   - "What sacrifices did you make for your career?"
   - "If you could change one thing about your professional journey, what would it be?"
...
3. **Children & Grandchildren**
   ...
   - "What traditions or values were most important to pass on to your children?"
   - "What has surprised you most about being a parent or grandparent?"
...
2. **Cultural Context**
   - "What were the popular trends, music, and entertainment during your youth?"
   - "How have social attitudes changed throughout your lifetime?"
   - "What aspects of your generational experience do you think younger people misunderstand?"
...
4. **Clarification**: Questions that resolve ambiguities or fill gaps.
   - Initial: "What career path did you initially pursue?"
   - Follow-up: "You mentioned changing careers in your thirties. What prompted that change?"

## 6. Question Presentation Strategy

The application will implement the following strategies for question presentation:

1. **Progressive Disclosure**: Starting with broader questions before moving to more specific ones.

2. **Adaptive Sequencing**: Adjusting question order based on the user's response patterns and comfort level.

3. **Optional Questions**: Clearly marking sensitive or optional questions that users can skip.

4. **Custom Questions**: Allowing users to add their own questions to any category.

5. **Thematic Sessions**: Grouping related questions to help users focus on one life aspect at a time.

6. **Reflection Prompts**: Interspersing direct questions with reflective prompts that encourage deeper thinking.